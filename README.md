...
<img width="506" height="522" alt="image" src="https://github.com/user-attachments/assets/7afd6813-6863-40ca-babb-5f8a43e1f1be" />
...
<img width="474" height="506" alt="image" src="https://github.com/user-attachments/assets/43744053-d5d6-45a0-a3fa-85236b7b68fe" />
...
<img width="474" height="490" alt="image" src="https://github.com/user-attachments/assets/55425169-bd86-4704-acc4-4596d5090596" />
...
<img width="584" height="574" alt="image" src="https://github.com/user-attachments/assets/6010c077-c99f-4c3f-9035-ee018d2fe67d" />
...
For each mesh, a quality check is performed by visualizing reconstruction errors and calculating the Average Symmetric Surface Distance (ASSD). A window will appear with 4 subpannels:
 * Top left: Distances visualized from points on the original mesh to the surface of the registered (reconstructed) mesh. The original mesh is coloured according to those distances (purple inside the bone and green outside fo the bone). The registered mesh is visualized as a wireframe.
 * Top right: Distances visualized from points on the registered mesh to the surface of the original mesh. The registered mesh is coloured according to those distances (purple inside the bone and green outside fo the bone). The original mesh is visualized as a wireframe.
 * Bottom left: 20 arbitrary points visualized on the reference (mean) mesh
 * Bottom right: The same 20 points visualized on the registered mesh, to assess how well homology was achieved. 
